...
# Parameter.create(name: 'inicio',type:'date' ,value:"'2000-01-01 00:00:00'", query: vlTotReQuery)
# Parameter.create(name: 'fim',type:'date' ,value:"'2014-12-30 00:00:00'", query: vlTotReQuery )
...
# Parameter.create(name: 'inicio',type:'date' ,value:"'2000-01-01 00:00:00'", query: vlVendasTotQuery)
# Parameter.create(name: 'fim',type:'date' ,value:"'2014-12-30 00:00:00'", query: vlVendasTotQuery )
# Parameter.create(name: 'situacao',type:'varchar' ,value:"'LOC Locado'", query: vlVendasTotQuery)
...
Parameter.create(name: 'inicio', type:'date' ,value:"'2000-01-01 00:00:00'", query: fatQuery)
Parameter.create(name: 'fim', type:'date' ,value:"'2014-12-30 00:00:00'", query: fatQuery )
...
Parameter.create(name: 'inicio',type:'date' ,value:"'2000-01-01 00:00:00'", query: vlInadimplenciaQuery)
Parameter.create(name: 'fim',type:'date' ,value:"'2014-12-30 00:00:00'", query: vlInadimplenciaQuery )
...
Parameter.create(name: 'situacoes',type:'varchar' ,value:"'LOC Locado', 'LOC Finalizado', 'LOC Cancelado'", query: novosContratosQuery)
Parameter.create(name: 'inicio',type:'date' ,value:"'2000-01-01 00:00:00'", query: novosContratosQuery)
Parameter.create(name: 'fim',type:'date' ,value:"'2014-12-30 00:00:00'", query: novosContratosQuery )
...
Parameter.create(name: 'situacao',type:'varchar' ,value:"'LOC Locado'", query: contratosAtivosQuery)
Parameter.create(name: 'fim',type:'date' ,value:"'2014-12-30 00:00:00'", query: contratosAtivosQuery )
...
Parameter.create(name: 'situacoes',type:'varchar' ,value:"'LOC Locado', 'LOC Finalizado', 'LOC Cancelado'", query: novosContratosDiaQuery)
Parameter.create(name: 'inicio',type:'date' ,value:"'2000-01-01 00:00:00'", query: novosContratosDiaQuery)
Parameter.create(name: 'fim',type:'date' ,value:"'2014-12-30 00:00:00'", query: novosContratosDiaQuery )
...
Parameter.create(name: 'inicio',type:'date' ,value:"'2000-01-01 00:00:00'", query: clientesMaisLocaramQuery)
Parameter.create(name: 'fim',type:'date' ,value:"'2014-12-30 00:00:00'", query: clientesMaisLocaramQuery )
Parameter.create(name: "situacao",type:'varchar' ,value:"'LOC Locado'", query: clientesMaisLocaramQuery)
...
Parameter.create(name: 'inicio',type:'date' ,value:"'2014-10-30 00:00:00'", query: pedidosPorSituacaoQuery)
Parameter.create(name: 'fim',type:'date' ,value:"'2014-11-30 00:00:00'", query: pedidosPorSituacaoQuery )
...
rmpoa = DatasourceServer.create(url: "http://prod-04:3000/api", name:'RM POA', description: '')
Permission.create(dashboard: dash, datasource_server: rmpoa, user: user)
